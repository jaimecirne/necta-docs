...
The complete architecture of this distributed data processing pipeline, from initial ingestion via \textit{VisionICeIO} to parallel execution via Dask and frontend visualization, is illustrated in Figure~\ref{fig:necta_architecture}.
